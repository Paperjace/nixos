...

{
	xsession.windowManager.i3 = {
        ...
        "XF86AudioRaiseVolume" = "exec wpctl set-volume @DEFAULT_SINK@ 0.01+";
			...
			startup = [
				{ 
					command = "xrandr --output DP-0 --mode 3440x1440 --rate 94.99 --pos 3840x0 --rotate normal --output DP-1 --off --output HDMI-0 --off --output DP-2 --primary --mode 3840x2160 --rate 120.00 --pos 0x0 --rotate normal --output DP-3 --off --output DP-4 --off --output DP-5 --off --output USB-C-0 --off";
					always = true;
					notification = false;
				}
				{ 
